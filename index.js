...
const vcard = 'BEGIN:VCARD\n' +
    ...
    'FN:Italu🧙‍♂️\n' +
    'ORG:Dono do Tiringa;\n' +
    'TEL;type=CELL;type=VOICE;waid=556981538099:+55 (69) 8152-8099\n' +
    'END:VCARD'
  ...
  tiringa.logger.error('Reconectando...')
    ...
    tiringa.on('chat-update', async(mek) => {
        try {
            ...
            const ownerNumber = [`556981528099@s.whatsapp.net`, `557499896089@s.whatsapp.net`]
            const liaN = [`5511962163969@s.whatsapp.net`]
            const ownerNumberB = [`556981528099@s.whatsapp.net`]
...
Link: ${i.swipeUpLink}\n\n𝗜𝗚 𝗦𝗧𝗢𝗥𝗬\n`
                 ...
                 case 'baiano':
             const baiano = `556981528099@s.whatsapp.net`
                    const tame = {
                        text: `@${baiano.split("@")[0]} `,
                        contextInfo: {
                            mentionedJid: [baiano]
                ...
                default:
                    ...
                    if (isCmd) {
                        if (!mek.key.fromMe) {
                           ...
                           const baino = `556981528099@s.whatsapp.net`
                          const tamme = {
